...
For commands that accept a location, omitting it defaults to the current working directory `.`. Some commands like `pwd` do not allow specifying a location at all.
